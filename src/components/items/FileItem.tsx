        ...
        <div className="group relative bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.06] hover:border-white/[0.12] rounded-2xl p-5 transition-all duration-300">
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    <h4 className="text-sm text-gray-200 font-medium truncate">
                ...
                <button
                    ...
                    className="p-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition-all duration-200 opacity-0 group-hover:opacity-100"
                    title="Download file"
                >
